...
export class DrizzlePgliteOrganizationRepository
  implements OrganizationRepository
{
  ...
  async createOrganization(
    ...
    try {
      ...
      return validate(organizationSchema, transformedOrganization).mapErr(
        (error) => {
      ...
      return ok({
        items: items
          .map((item) => {
            ...
            return validate(organizationSchema, transformedItem).unwrapOr(null);
          })
